...
flowchart TD
  ...
  Auth --> Dashboard[Supporter dashboard]
  Auth --> NGO[NGO routes]
  Auth --> Corporate[Corporate routes]
  Auth --> Volunteer[Volunteer routes]
  Auth --> Admin[Admin routes]
  Public --> Campaigns[/campaigns/]
  Public --> NGOs[/ngos/]
  Public --> Community[/community/]
  Dashboard --> Giving[/dashboard/giving/]
  NGO --> NGODash[/ngo/dashboard/]
  Corporate --> CSR[/corporate/settlements/]
