          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <p className="text-slate-600 text-[15px] leading-relaxed mb-8">
                Our real-time dashboard shows the collective difference
                we&apos;re making across India.
              </p>
              <motion.button
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
                {[
                  ...
                  <div
                    key={stat.label}
                    className="border border-slate-100 rounded-xl p-3 flex items-center gap-3 shadow-[0_2px_8px_rgb(0,0,0,0.02)] hover:shadow-md transition-shadow bg-white min-w-0"
                  >
                    <stat.icon
                      className={`w-6 h-6 ${stat.color} shrink-0`}
                      strokeWidth={1.5}
                    />
                    <div className="min-w-0">
                      <p
                        className={`text-[13px] md:text-[14px] font-bold ${stat.color} truncate leading-tight`}
                      >
                        {stat.value}
                      </p>
                      <p className="text-[9px] md:text-[10px] text-slate-500 font-semibold mt-0.5 leading-tight">
                        {stat.label}
                      </p>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="border border-slate-100 rounded-xl p-4 shadow-sm bg-white">
                  <h4 className="text-[11px] font-bold text-slate-700 mb-4">
                    Impact by Cause
                  </h4>
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1.5 w-full">
                      {[
                        ...
                        <div
                          key={item.label}
                          className="flex items-center justify-between w-full text-[9px] text-slate-600"
                        >
                ...
                <div className="border border-slate-100 rounded-xl p-4 shadow-sm bg-white flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    {[
                      {
                        img: "/landing_page_images/feature_tiles/give_with_confidence.png",
                        title: "Rural Education Support",
                        sub: "Progress updated • 2h ago",
                      },
                      {
                        img: "/landing_page_images/feature_tiles/volunteer_your_skills.png",
                        title: "Healthcare for All",
                        sub: "New milestone reached • 5h ago",
                      },
                      {
                        img: "/landing_page_images/feature_tiles/grow_your_impact.png",
                        title: "Clean Water Initiative",
                        sub: "25 new villages covered • 1d ago",
                      },
                    ].map((update, i) => (
                      <div
                        key={i}
              ...
              <div className="border border-slate-100 rounded-xl p-4 shadow-sm bg-white">
                ...
                <div className="relative flex justify-between items-start px-4 mt-3">
                  ...
                  {[
                    {
                      month: "Jan",
                      desc: "Donated to 3 campaigns",
                      icon: HandHeart,
                      bg: "bg-[#2563eb]",
                    },
                    {
                      month: "Mar",
                      desc: "Volunteered 12 hours",
                      icon: Users,
                      bg: "bg-[#16a34a]",
                    },
                    {
                      month: "Jun",
                      desc: "Shared a campaign",
                      icon: Share2,
                      bg: "bg-[#0d9488]",
                    },
                    {
                    ...
                    >
                      <div
                        className={`w-8 h-8 rounded-full ${node.bg} text-white flex items-center justify-center ring-[6px] ring-white shadow-sm`}
                      >
                      ...
                      <div className="text-center mt-1">
                        ...
                        <p className="text-[9px] font-medium text-slate-500 max-w-[80px] leading-[1.3]">
                          {node.desc}
                        </p>
                      </div>
                    </div>
