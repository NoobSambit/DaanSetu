...
const steps = [
  {
    ...
    title: "Discover",
    description:
      "Explore causes by category, location, or need. Find verified NGOs and campaigns you care about.",
  },
  {
    icon: Handshake,
    ...
    title: "Connect",
    description:
      "Learn about the organization, read reviews, and see how your support can help.",
  },
  {
    icon: HandHeart,
    ...
    title: "Contribute",
    description:
      "Donate, volunteer, fundraise, or start a campaign. Every action creates impact.",
  },
  {
    icon: TrendingUp,
    ...
    title: "Track Impact",
    description:
      "Follow real-time updates, transparent reports, and stories of change you helped create.",
  },
];
        ...
        <div className="relative w-full mt-8">
          ...
          <div className="hidden lg:block absolute top-[-70px] left-0 w-full h-[200px] z-0 select-none pointer-events-none">
            ...
            >
              ...
              <path
                d="M -33.33 20 Q 100 220 233.33 20"
                stroke="#94a3b8"
                strokeWidth="3.5"
                fill="none"
              />
              <path
                d="M 233.33 20 Q 366.67 220 500 20"
                stroke="#94a3b8"
                strokeWidth="3.5"
                fill="none"
              />
              <path
                d="M 500 20 Q 633.33 220 766.67 20"
                stroke="#94a3b8"
                strokeWidth="3.5"
                fill="none"
              />
              <path
                d="M 766.67 20 Q 900 220 1033.33 20"
                stroke="#94a3b8"
                strokeWidth="3.5"
                fill="none"
              />
              ...
              {[233.33, 500, 766.67].map((x) => (
                <g key={x}>
                  ...
                  {/* Tower Pillar */}
                  <path
                    d={`M ${x - 6} 120 L ${x - 4} 10 L ${x + 4} 10 L ${x + 6} 120`}
                    fill="#ffffff"
                    stroke="#cbd5e1"
                    strokeWidth="1.5"
                  />
                  <path
                    d={`M ${x - 6} 10 L ${x + 6} 10 L ${x + 6} -5 L ${x - 6} -5 Z`}
                    fill="#94a3b8"
                  />
              ...
              return (
                ...
                >
                  ...
                  <div className="relative inline-flex mb-8">
                    ...
                    <div
                      className={`absolute inset-0 ${step.iconBg} rounded-full blur-xl opacity-0 group-hover:opacity-30 transition-opacity duration-500`}
                    />
                    ...
                    <div className="relative w-[100px] h-[100px] rounded-full bg-white flex items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-slate-100 group-hover:-translate-y-1 transition-transform duration-300">
                      <div
                        className={`w-[64px] h-[64px] ${step.iconBg} rounded-full flex items-center justify-center shadow-inner group-hover:scale-105 transition-transform duration-300`}
                      >
                        <step.icon
                  ...
                  <div className="flex items-center justify-center gap-3 mb-4">
                    <span
                      className={`w-7 h-7 rounded-full flex items-center justify-center text-[12px] font-bold text-white shadow-md ${step.badgeBg}`}
                    >
                      {step.number}
                    </span>
