    ...
    <section className="relative pt-20 pb-6 bg-transparent">
      <div className="container-custom text-center">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-[#0f172a] mb-3 leading-tight">
            A Community That Celebrates Impact
          </h2>
          <p
            className="text-white text-sm font-bold mb-1.5 tracking-wide"
            style={{ textShadow: "0 1px 8px rgba(0,0,0,0.5)" }}
          >
            Follow. Share. Inspire.
          </p>
          <p
            className="text-white/90 text-xs max-w-md mx-auto mb-8 font-medium"
            style={{ textShadow: "0 1px 6px rgba(0,0,0,0.5)" }}
          >
            Together, let&apos;s build a world of kindness, compassion, and a
            sustainable future.
          </p>
        </motion.div>
