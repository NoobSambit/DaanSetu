      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-[1fr_1.3fr] gap-x-10 gap-y-10">
          ...
          <div className="flex flex-col">
            ...
            >
              <h2 className="text-2xl md:text-[28px] font-serif font-bold text-[#1e3a8a] mb-2">
                Trust & Transparency You Can Rely On
              </h2>
              <p className="text-slate-500 text-[15px]">
                Every NGO, every campaign, every rupee is accountable
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="grid grid-cols-3 gap-y-8 gap-x-2 mb-10"
            >
              {trustBadges.map((badge, index) => (
                ...
                >
                  <div
                    className={`w-[56px] h-[56px] bg-white rounded-full flex items-center justify-center border ${badge.border} shadow-sm`}
                  >
                    <badge.icon
                      className={`w-[24px] h-[24px] ${badge.color}`}
                      strokeWidth={1.5}
                    />
                  </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white border border-slate-200 rounded-[20px] p-6 shadow-sm flex flex-col relative overflow-hidden mt-auto"
            >
              <div className="flex items-start gap-5">
                ...
                <div className="flex-1 flex flex-col pt-1 pb-6">
                  <blockquote className="text-slate-600 text-[14px] leading-[1.6] mb-3">
                    &ldquo;Transparent updates and real stories give me
                    confidence that my contribution truly makes a
                    difference.&rdquo;
                  </blockquote>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="bg-white border border-slate-200 rounded-[20px] shadow-sm flex flex-col overflow-hidden h-full"
          >
            ...
            <div className="relative w-full h-[180px] bg-slate-100 flex items-center shrink-0">
              ...
              <div className="absolute right-0 top-0 bottom-0 w-[60%] bg-slate-200 overflow-hidden flex justify-center items-center">
                <span className="text-slate-400 text-xs font-medium bg-white/50 px-3 py-1 rounded backdrop-blur-sm">
                  Children learning image
                </span>
              </div>
              ...
              <div className="relative z-10 px-6 py-5 max-w-[65%] flex flex-col justify-center h-full">
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <span className="text-[11px] font-bold text-green-700 tracking-wider">
                    VERIFIED NGO
                  </span>
                </div>

                <h3 className="text-[20px] font-serif font-bold text-[#1e3a8a] mb-1">
                  Prerna Foundation
                </h3>
                ...
                <p className="text-[11px] text-slate-600 leading-snug line-clamp-2 mb-3 max-w-[90%]">
                  Working for quality education and holistic development of
            ...
            <div className="px-6 pt-5 mb-4">
              <h4 className="text-[14px] font-bold text-[#1e3a8a] mb-3">
                Library & Learning Center for Rural Children
              </h4>
              ...
              <p className="text-[11px] text-slate-500">
                <span className="font-bold text-slate-700">₹8,75,000</span>{" "}
                raised of ₹12,00,000
              </p>
            </div>
            ...
            <div className="flex items-center justify-between px-6 mb-5">
              <div className="flex items-start gap-2.5">
                <Users
                  className="w-[22px] h-[22px] text-[#2563eb] shrink-0 mt-0.5"
                  strokeWidth={1.5}
                />
                <div className="flex flex-col">
                  <p className="text-[13px] font-bold text-[#1e3a8a] leading-none">
                    1,250
                  </p>
              ...
              <div className="flex items-start gap-2.5">
                <Building2
                  className="w-[22px] h-[22px] text-emerald-600 shrink-0 mt-0.5"
                  strokeWidth={1.5}
                />
                <div className="flex flex-col">
                  <p className="text-[13px] font-bold text-[#1e3a8a] leading-none">
              ...
              <div className="flex items-start gap-2.5">
                <BookOpen
                  className="w-[22px] h-[22px] text-green-600 shrink-0 mt-0.5"
                  strokeWidth={1.5}
                />
                <div className="flex flex-col">
                  <p className="text-[13px] font-bold text-[#1e3a8a] leading-none">
