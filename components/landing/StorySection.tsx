      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div>
              <h2 className="text-2xl font-serif font-bold text-[#1e293b] mb-6 leading-tight">
                ...
                <span className="text-[#2563eb]">Becomes a Story of Change</span>
              </h2>
              
              <h3 className="text-[15px] font-bold text-[#1e293b] mb-1">From a Struggle to a Future</h3>
              <p className="text-[11px] text-slate-500 mb-3">Meena&apos;s journey with education</p>
              
              <p className="text-[13px] text-slate-600 leading-relaxed mb-6">
                Meena, from a small village in Bihar, had to walk 5 km daily to attend school. With support from a DaanSetu funded education program, her village now has a learning center.
              </p>
              ...
              <div className="flex justify-between items-center mb-6 px-1">
                <div className="flex flex-col items-center gap-1.5">
                  ...
                  <div className="text-center">
                    <span className="font-bold text-[13px] text-[#1e293b] block">150</span>
                    <span className="text-[9px] text-slate-500 leading-tight block">Children<br/>Educated</span>
                  </div>
                </div>
                <div className="flex flex-col items-center gap-1.5">
                  <UserCheck className="w-5 h-5 text-[#b45309]" />
                  <div className="text-center">
                    <span className="font-bold text-[13px] text-[#1e293b] block">12</span>
                    <span className="text-[9px] text-slate-500 leading-tight block">Teachers<br/>Trained</span>
                  </div>
                </div>
                <div className="flex flex-col items-center gap-1.5">
                  <GraduationCap className="w-5 h-5 text-[#b45309]" />
                  <div className="text-center">
                    <span className="font-bold text-[13px] text-[#1e293b] block">98%</span>
                    <span className="text-[9px] text-slate-500 leading-tight block">School<br/>Attendance</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-[13px] text-slate-600 font-medium px-2">Limited access to education</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-[13px] text-slate-600 font-medium px-2">Confident, learning, and dreaming big</p>
          </motion.div>
            ...
            <div>
              <div className="mb-5 text-[#1e3a8a]">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10 11C10 13.2 8.4 15 6 15C3.6 15 2 13.2 2 11C2 8.8 4 6 7 6V8C5.5 8 4.5 9 4.2 10.2C4.7 10 5.3 9.8 6 9.8C8.2 9.8 10 10.4 10 11ZM20 11C20 13.2 18.4 15 16 15C13.6 15 12 13.2 12 11C12 8.8 14 6 17 6V8C15.5 8 14.5 9 14.2 10.2C14.7 10 15.3 9.8 16 9.8C18.2 9.8 20 10.4 20 11Z" fill="currentColor"/>
                </svg>
              </div>
              <p className="text-[#334155] text-[15px] font-medium leading-relaxed mb-6">
                &ldquo;Now I dream of becoming a teacher and helping other children like me.&rdquo;
              </p>
              <div>
                <p className="text-[13px] font-bold text-[#1e3a8a] mb-0.5">— Meena Kumari</p>
