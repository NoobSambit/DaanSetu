...
const LogoIcon = () => (
  ...
  >
    <path
      d="M12 28C14.2091 28 16 26.2091 16 24C16 21.7909 14.2091 20 12 20C9.79086 20 8 21.7909 8 24C8 26.2091 9.79086 28 12 28Z"
      fill="#2563EB"
    />
    <path
      d="M16 34C16 30.6863 13.3137 28 10 28H14C17.3137 28 20 30.6863 20 34"
      stroke="#2563EB"
      strokeWidth="2.5"
      strokeLinecap="round"
    />
    ...
    />
    <path
      d="M28 34C28 30.6863 25.3137 28 22 28H26C29.3137 28 32 30.6863 32 34"
      stroke="#F97316"
      strokeWidth="2.5"
      strokeLinecap="round"
    />
    ...
    />
    <path
      d="M40 34C40 30.6863 37.3137 28 34 28H38C41.3137 28 44 30.6863 44 34"
      stroke="#2563EB"
      strokeWidth="2.5"
      strokeLinecap="round"
    />
...
const DiscoverIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M16.2426 7.75736L11.2929 11.2929L7.75736 16.2426L12.7071 12.7071L16.2426 7.75736Z"
      stroke="white"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const DonorBadge = () => (
  ...
  >
    ...
    />
    <path
      d="M22 22C22 19.7909 19.3137 18 16 18C12.6863 18 10 19.7909 10 22"
      stroke="#0EA5E9"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M16 15C16.8284 15 17.5 14.3284 17.5 13.5C17.5 12.6716 16.8284 12 16 12C15.1716 12 14.5 12.6716 14.5 13.5C14.5 14.3284 15.1716 15 16 15Z"
      fill="#E0F2FE"
    />
    <path
...
const VolunteerBadge = () => (
  ...
  >
    ...
    <path
      d="M9 21C9 18.7909 10.7909 17 13 17C14.1046 17 15.1046 17.4477 15.8284 18.1716"
      stroke="#10B981"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    <path
      d="M15 22C15 19.7909 16.7909 18 19 18C21.2091 18 23 19.7909 23 22"
      stroke="#10B981"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
...
const CSRBadge = () => (
  ...
  >
    ...
    <path
      d="M13 13V11C13 10.4477 13.4477 10 14 10H18C18.5523 10 19 10.4477 19 11V13"
      stroke="#F97316"
      strokeWidth="1.5"
      strokeLinecap="round"
    />
    ...
    <main className="h-screen min-h-[700px] w-full bg-[#F8FAFC] flex overflow-hidden relative">
      ...
      <div className="mx-auto w-full h-full max-w-[1500px] flex relative z-10">
        ...
        <aside className="relative flex-[1.1] bg-white/80 backdrop-blur-xl border-r border-slate-100/50 px-8 py-8 lg:px-16 flex flex-col justify-center h-full overflow-hidden">
          ...
          <Link
            href="/"
            className="absolute top-8 left-8 lg:left-16 flex items-center gap-1.5 text-[13px] font-medium text-slate-400 hover:text-slate-900 transition-colors group"
          >
            <svg
              width="16"
              height="16"
          ...
          <div className="flex items-center gap-3 text-slate-950 mb-8 mt-8">
            ...
            <div className="flex flex-col">
              <span className="text-[20px] font-bold text-[#1e3a8a] leading-tight">
                DaanSetu
              </span>
              <span className="text-[9px] font-bold tracking-widest text-slate-400 uppercase mt-[1px]">
                A Bridge for Giving
              </span>
            </div>
          </div>
          ...
          <div className="max-w-[640px] flex-1 flex flex-col justify-center">
            ...
            <p className="text-[15px] text-slate-500 mb-10 max-w-[500px] leading-relaxed">
              Support causes, volunteer your skills, grow your NGO, or manage
              CSR initiatives through one transparent platform.
            </p>
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
              ...
              <div className="flex-[1.2] relative">
                ...
                <div className="space-y-5 relative z-10">
                  ...
                  <div className="flex items-start gap-5">
                    <div className="mt-3 shrink-0 bg-white">
                      <StepIndicator />
                    </div>
                    <div className="flex items-center gap-4 w-full bg-white rounded-xl border border-slate-100 p-3 shadow-sm">
                      ...
                      <div>
                        <h3 className="font-bold text-[#0f172a] text-[12px] uppercase tracking-wider mb-1">
                          Discover
                        </h3>
                        <p className="text-[12px] text-slate-500 leading-tight">
                          Explore verified causes and impact opportunities.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex items-center gap-4 w-full bg-white rounded-xl border border-slate-100 p-3 shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] text-slate-500 leading-tight">
                          Connect with NGOs, volunteers, and CSR partners.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex items-center gap-4 w-full bg-white rounded-xl border border-slate-100 p-3 shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] text-slate-500 leading-tight">
                          Donate, volunteer, or support initiatives that matter.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-5">
                    ...
                    <div className="flex items-center gap-4 w-full bg-white rounded-xl border border-slate-100 p-3 shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-[12px] text-slate-500 leading-tight">
                          Track progress and see the real impact of your
                          support.
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex-1 min-w-[260px]">
                <h3 className="font-bold text-[#0f172a] mb-5 text-[14px]">
                  Who can join DaanSetu?
                </h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm flex flex-col justify-center items-center text-center">
                    ...
                    <h4 className="font-bold text-[#0f172a] mb-1.5 text-[12px]">
                      Donors
                    </h4>
                    <p className="text-[11px] text-slate-500 leading-tight">
                      Support meaningful causes and create lasting impact.
                    </p>
                  </div>
                  <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm flex flex-col justify-center items-center text-center">
                    <div className="mb-2.5">
                    ...
                    <p className="text-[11px] text-slate-500 leading-tight">
                      Share your skills and make a real difference.
                    </p>
                  </div>
                  <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm flex flex-col justify-center items-center text-center">
                    <div className="mb-2.5">
                    ...
                    <p className="text-[11px] text-slate-500 leading-tight">
                      Grow your impact and reach more communities.
                    </p>
                  </div>
                  <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm flex flex-col justify-center items-center text-center">
                    <div className="mb-2.5">
                    ...
                    <p className="text-[11px] text-slate-500 leading-tight">
                      Drive CSR initiatives and measure social impact
                      transparently.
                    </p>
                  </div>
                </div>
        ...
        <section className="flex-[0.9] flex items-center justify-center p-6 lg:p-12 h-full overflow-y-auto">
          <div className="w-full max-w-[520px]">
            <div className="bg-white rounded-[28px] p-8 lg:p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              {title && description && (
                <div className="mb-8">
                  <h2 className="text-[26px] font-bold text-[#0f172a] tracking-tight mb-2">
                    {title}
                  </h2>
