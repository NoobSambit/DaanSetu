  ...
  return (
    <form action={formAction} className="space-y-5">
      ...
      {notice && (
        <div
          role="status"
          className="rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-[13px] text-emerald-800 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)]"
        >
          {notice}
        </div>
      )}
      ...
      {initialError && (
        <div
          role="alert"
          className="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-[13px] text-red-800 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.02)]"
        >
          {initialError}
        </div>
      )}
      ...
      <div>
        ...
        <div className="relative">
          ...
          />
          <input type="hidden" value={password} className="hidden" />
          <div
