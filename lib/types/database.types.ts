...
// Application-facing aliases. `supabase gen types` owns the schema types above;
// these narrow checked text columns and provide stable names used by UI and
// service modules. Keep this section when regenerating the file.
...
export type CorporateCampaignStatus = "active" | "completed" | "cancelled";
export type PostCategory = "update" | "story" | "announcement";
export type PostAuthorRole = "supporter" | "ngo" | "corporate" | "admin";
...
export type Notification = Tables<"notifications"> & { created_at: string };
export type VolunteerProfile = Tables<"volunteer_profiles">;
export type AIFlag = Tables<"ai_flags">;
export type UserBadge = Tables<"user_badges"> & {
  badge_type: BadgeType;
  earned_at: string;
};
export type CorporateProfile = Tables<"corporate_profiles"> & {
  company_size: CorporateSize;
};
export type CorporateCampaign = Tables<"corporate_campaigns"> & {
  cause: CorporateCampaignCause;
  status: CorporateCampaignStatus;
};
export type CorporateEmployee = Tables<"corporate_employees"> & {
  joined_at: string;
};
export type PartnershipRequest = Tables<"partnership_requests"> & {
  created_at: string;
};
...
export type PostComment = Tables<"post_comments"> & { created_at: string };
