...
export async function createCorporateCampaign(
  params: CreateCorporateCampaignParams,
...
export async function updateCorporateCampaign(
  params: UpdateCorporateCampaignParams,
  supabaseClient?: SupabaseClient,
) {
  const supabase = supabaseClient || getBrowserClient();
...
export async function incrementCorporateCampaignAmount(
  campaignId: string,
  amount: number,
  supabaseClient?: SupabaseClient,
) {
