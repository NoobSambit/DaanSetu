...
export default function EnhancedPostFeed({ initialPosts, userId }: EnhancedPostFeedProps) {
  const [posts, setPosts] = useState<PostWithAuthor[]>(initialPosts)
  const [filteredPosts, setFilteredPosts] = useState<PostWithAuthor[]>(initialPosts)
  ...
  const handleFilterChange = (filters: {
    ...
    if (filters.authorRole) {
      filtered = filtered.filter(post => post.author_role === filters.authorRole)
    }
