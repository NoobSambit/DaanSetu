...
export default function EnhancedPostCard({ post, userId }: EnhancedPostCardProps) {
      ...
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <Link href={`/profile/${post.author_id}`}>
                <p className="font-semibold text-gray-900 hover:text-blue-600 cursor-pointer">{post.author.name}</p>
              </Link>
        ...
        <div className="flex items-center space-x-6 text-sm text-gray-500 mb-4">
          ...
          {post.view_count !== undefined && <span>👁️ {post.view_count} views</span>}
        </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <Link href={`/profile/${comment.user_id}`}>
                          <span className="font-semibold text-sm text-gray-900 hover:text-blue-600 cursor-pointer">{comment.user.name}</span>
                        </Link>
