              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-gray-900">Impact Stories</span>
                  </div>
                  <p className="text-xs text-gray-600 mt-1">Featured success stories</p>
                </Link>
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="text-xl">🔖</span>
                    <span className="font-semibold text-gray-900">Saved Posts</span>
                  </div>
                  <p className="text-xs text-gray-600 mt-1">Your bookmarked content</p>
                </Link>
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="text-xl">📊</span>
                    <span className="font-semibold text-gray-900">Your Activity</span>
                  </div>
                  <p className="text-xs text-gray-600 mt-1">View your timeline</p>
                </Link>
              </div>
            </div>
