...
export default async function CampaignManagementPage({
  ...
  return (
    <main className="page-frame">
      <section className="page-content max-w-4xl">
        <PageHeader
          eyebrow="Campaign management"
          title={campaign.title}
          description={`Current state: ${campaign.status.replaceAll("_", " ")}. Keep campaign details, milestones, and review requirements in sync here.`}
        />
        <div className="panel p-5 sm:p-8">
          ...
          {canEdit && (
            <form
              ...
              className="mt-8 space-y-5 rounded-xl border border-slate-200 p-5 sm:p-6"
            >
              ...
              {campaign.ngo_id === null && (
                <fieldset className="space-y-4 rounded-xl border border-amber-200 bg-amber-50 p-5">
                  ...
                  <p className="text-xs text-amber-900">
                    ...
                    {payoutAccount?.status ?? "not linked"}
                  </p>
                </fieldset>
              )}
              <label className="block text-sm font-semibold text-slate-800">
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 p-6">
            ...
            {canEdit && (
              ...
              >
                ...
                />
                <textarea
                  className="input min-h-24 resize-y sm:col-span-2"
                  maxLength={1_000}
                  name="description"
            ...
            ["draft", "changes_requested"].includes(campaign.status) && (
              ...
              >
                ...
                <p className="text-sm text-blue-900">
                  Submit only after beneficiary, evidence, and payout details
                  are complete. An admin must approve the fundraiser before it
                  can go live.
                </p>
