  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-8">
        {/* Breadcrumb */}
        <div className="mb-6">
          <Link href="/campaigns" className="text-blue-600 hover:text-blue-700 text-sm">
            ← Back to Campaigns
          </Link>
        </div>
          ...
          <div className="p-8">
            ...
            <div className="mb-4">
              <span className="inline-block bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-semibold">
                {categoryEmojis[campaign.category]} {campaign.category.charAt(0).toUpperCase() + campaign.category.slice(1)}
              </span>
            </div>
            ...
            >
              by {campaign.ngos.name} • {campaign.ngos.city}, {campaign.ngos.state}
            </Link>

            {/* Short Description */}
            <p className="text-xl text-gray-700 mb-6">{campaign.short_description}</p>
