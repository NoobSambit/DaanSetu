    ...
    return (
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg shadow-lg p-6 text-white mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold mb-2">Find Campaigns Perfect for You</h2>
            <p className="text-blue-100">Let AI suggest campaigns based on your interests and donation history</p>
          </div>
          <button
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Campaigns Recommended for You</h2>
      ...
      {loading && (
        <div className="text-center py-12">
          ...
          <p className="mt-4 text-gray-600">Finding perfect campaigns for you...</p>
        </div>
      )}
      ...
      {!loading && !error && suggestions.length === 0 && (
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="font-medium">No matching campaigns found at the moment.</p>
      ...
      {suggestions.length > 0 && (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {suggestions.map((suggestion, index) => (
            <div key={index} className="border-2 border-blue-200 rounded-lg p-5 hover:border-blue-400 hover:shadow-md transition bg-blue-50/30">
              <div className="flex items-center gap-2 mb-3">
                <span className={`text-xs px-2 py-1 rounded-full font-medium ${categoryColors[suggestion.category] || 'bg-gray-100 text-gray-800'}`}>
              ...
              <div className="bg-white rounded-lg p-3 mb-4 border border-blue-100">
                <p className="text-xs font-semibold text-blue-900 mb-1">Why this campaign?</p>
