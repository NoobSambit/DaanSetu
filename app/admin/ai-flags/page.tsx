  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">AI Quality Flags</h1>
          <p className="text-gray-600">Review content flagged by the AI system for potential quality issues</p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Total Flags</p>
                <p className="text-3xl font-bold text-gray-900">{flagsList.length}</p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">NGO Flags</p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 mb-1">Campaign Flags</p>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          ...
          {enrichedFlags.length === 0 ? (
            <div className="p-12 text-center">
              ...
              <p className="text-lg font-medium text-gray-900 mb-2">No flags found</p>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold border ${confidenceColors[flag.confidence] || confidenceColors.medium}`}>
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-500">
                        <span>
                          Flagged on {new Date(flag.created_at).toLocaleDateString('en-IN', {
                            day: 'numeric',
                            month: 'short',
                            year: 'numeric',
                          })}
