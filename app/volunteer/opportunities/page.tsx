...
export default function VolunteerOpportunitiesPage() {
  ...
  const [filteredOpportunities, setFilteredOpportunities] = useState<OpportunityWithNGO[]>([])
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        {filteredOpportunities.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            <p className="text-gray-600 mb-4">No opportunities found matching your filters</p>
            <button
              onClick={() => {
                setSelectedSkill('')
                setSelectedCity('')
