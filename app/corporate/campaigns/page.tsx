    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">My CSR Campaigns</h1>
            <p className="text-gray-600 mt-1">Manage your corporate social responsibility campaigns</p>
          </div>
          <Link
        ...
        {campaigns.length === 0 ? (
          <div className="bg-white rounded-lg shadow-sm p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Create your first CSR campaign to get started</p>
            <Link
              href="/corporate/campaigns/create"
