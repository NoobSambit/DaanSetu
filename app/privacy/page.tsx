    ...
    <main className="min-h-screen bg-slate-50 px-4 py-12">
      <article className="mx-auto max-w-3xl rounded-lg border border-slate-200 bg-white p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-6 text-sm leading-7 text-slate-700">
          ...
          <p>
            Passwords and authentication sessions are managed by Supabase Auth.
            DaanSetu does not store plaintext passwords.
          </p>
          <p>
            Public profile and organization information may be visible to other
            visitors. Authentication credentials and private session tokens are
